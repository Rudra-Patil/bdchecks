#'
#' Data check validation_month_empty Check if month vector is non empty.
#'
#'     This data check answers: "Is month information present?" question.\cr Data check will pass if \strong{The value for month is present.} and will fail if \strong{The value for month is missing.}.\cr Dimension of this data check is \strong{} and it's flagging type is: \strong{FLAG}\cr Example of entries that will pass: \code{month=2006-06-02}, such data check would return \code{TRUE}.\cr Example of entries that will fail: \code{month=}, such data check would return \code{FALSE}.
